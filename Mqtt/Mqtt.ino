...
const char* mqtt_server = "b6d522ef66224d36a55e598722e7338d.s1.eu.hivemq.cloud"; // replace with your broker url
...
const char* sensor1_topic= "Hola Mqtt";
...
publishMessage(sensor1_topic,String("99"),true); 
